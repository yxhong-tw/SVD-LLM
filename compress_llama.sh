...
# python SVDLLM.py --model /workspace/models/Meta-Llama-3-8B --step 1 --ratio 0.2 --whitening_nsamples 256 --dataset wikitext2 --seed 3 --model_seq_len 2048 --save_path . --DEV cuda:2
# python SVDLLM.py --model /workspace/models/Llama-3.1-8B --step 1 --ratio 0.2 --whitening_nsamples 256 --dataset wikitext2 --seed 3 --model_seq_len 2048 --save_path . --DEV cuda:3
...
python SVDLLM.py --step 4 --model_path _workspace_models_Meta_Llama_3_8B_whitening_only_0.8.pt --DEV cuda:2
